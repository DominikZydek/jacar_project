    ...
    <main>
        <div class="appointment-form">
            <form action="appointment.php" method="post">
                <div class="appointment-form-left-side">
                    <div class="choose-date">
                        <label for="date">Wybierz datę</label>
                        <input type="hidden" name="date" id="date" required>
                        <div class="interactive-calendar" id="datepicker">
                            <!-- inject via js -->
                        </div>
                    </div>
                </div>
                <div class="appointment-form-right-side">
                    ...
                    <div class="add-message">
                        <label for="message">Dodaj wiadomość</label>
